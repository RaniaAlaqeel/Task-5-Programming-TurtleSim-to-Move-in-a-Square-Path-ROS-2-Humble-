 ...
 * Create the Python script file (turtle_square.py):
   * Open the text editor:
     nano turtle_square.py
     

 * Paste the square movement code and save the file.
 * Grant execution permissions to the script:
   chmod +x turtle_square.py
   

 * Run the TurtleSim simulator (in a separate terminal window):
   ros2 run turtlesim turtlesim_node
   

 * Execute the square movement script:
